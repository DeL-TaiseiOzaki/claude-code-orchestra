...
- **Purpose**: {one sentence from README/AGENTS.md}
...
- **Current focus** (from AGENTS.md): {Current Project section, if present}
...
{List from .agents/docs/research/ with 1-line summaries}

### Library constraints
{List from .agents/docs/libraries/ with 1-line summaries}
...
{One-line summary per .agents/rules/*.md file}
...
_Sources: git log, AGENTS.md, .agents/rules/, .agents/skills/,
