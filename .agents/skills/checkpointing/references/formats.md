...
tags: [.agents, agent-teams, codex, feature, skills]
commits: 12
files_changed: 15
...
`.agents/checkpoints/INDEX.md` is the one-file catalog of every checkpoint,
...
> Auto-maintained by /checkpointing. Every checkpoint in `.agents/checkpoints/`, newest first.
...
|---|---|---|---|---|---|
| 2026-02-08-153000 | [feature-agent-teams](2026-02-08-153000.md) | main | .agents, agent-teams, codex, feature, skills | 12c/15f/3cx/1tm | redesign the feature skill; add the team-execute skill |
...
`.agents/logs/index-preview-*.md`, `--apply` to write, atomic replace, and a
