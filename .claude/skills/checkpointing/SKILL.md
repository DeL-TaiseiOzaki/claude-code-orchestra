---
name: checkpointing
description: Save session activity, rebuild rolling PROGRESS.md, and compact stale working blocks in .claude/STATE.md.
metadata:
...
1. **`.claude/checkpoints/INDEX.md`** — one table, newest first, with the
...
4. Ask for approval before replacing `.claude/STATE.md` or moving research
...
- Archive destinations use `.claude/docs/research/archive/`; append when a
